  ...
  return (
    <View className="flex-1 items-center justify-center bg-white px-6">
      <Image
        ...
        resizeMode="contain"
      />
      <Text className="mt-5 text-center text-3xl font-bold text-gray-900">Your account is ready</Text>
      ...
      <Pressable className="mt-10 w-full rounded-md bg-[#005823CC] py-4" onPress={() => router.push("/(protected)/(serviceUser)/(tabs)/index")}>
        <Text className="text-center font-semibold text-white">Go to Dashboard</Text>
      </Pressable>
      <Pressable className="mt-2 w-full rounded-md py-4" onPress={() => router.push("/(protected)/(serviceUser)/(tabs)/index")}>
