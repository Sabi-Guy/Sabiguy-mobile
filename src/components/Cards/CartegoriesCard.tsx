...
export default function CartegoriesCard({ image, text_one, text_two }: categoriesCardProps) {
  return (
    <TouchableOpacity className="h-24 rounded-2xl bg-white items-center justify-center shadow-sm">
